const qBank = [
  {
    ...
    answers: ["Alan Sugar", "Donald Trump", "Richard Branson", "Bill Gates"],
  ...
  },
  {
    ...
    answers: ["Moldova", "Czech Republic", "Wales", "Denmark"],
    correct: "Wales",
    questionId: "183452",
  },
  {
    ...
    answers: ["Oculus", "HTC", "Google", "Razer"],
    correct: "HTC",
    questionId: "267908",
  },
  {
  ...
  },
  {
    ...
    answers: ["Sword", "Pen", "Key", "Cellphone"],
    correct: "Key",
    questionId: "839754",
  },
  {
  ...
  },
  {
    ...
    answers: ["Money", "Keys", "Notebook", "Watch"],
    correct: "Watch",
    questionId: "1174154",
  },
  {
...
const Number = (n = 5) => Promise.resolve(qBank.sort(() => 0.5 - Math.random()).slice(0, n));
console.log(Number())
